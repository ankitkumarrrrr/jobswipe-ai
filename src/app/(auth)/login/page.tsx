      ...
      <div className="hidden lg:flex flex-1 items-center justify-center px-12">
        <div className="max-w-md text-right">
          ...
          <p className="text-gray-400 text-lg">
            While you prepare for interviews, our AI is sending customized
            applications to your dream companies.
          </p>
          <div className="mt-8 flex justify-end gap-8">
            ...
            <div>
              <div className="text-2xl font-bold text-violet-400">3.2x</div>
